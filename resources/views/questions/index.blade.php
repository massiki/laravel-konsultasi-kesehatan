  ...
  <section class="p-2">
    <div class="p-3">
      ...
      <div class="input-group mb-3">
        <form action="/questions" method="get" class="w-100 d-flex gap-2">
          <input type="text" class="form-control" placeholder="Cari judul konsultasi" aria-label="Recipient's username" aria-describedby="button-addon2" name="search">
          <button class="btn btn-primary" type="submit" id="button-addon2">Cari</button>
        </form>
      </div>

      <div class="d-flex justify-content-between my-2">
        <h2 class="m-0">All Questions</h2>
        @guest
        @else
            ...
            <div class="col-sm-12 col-md-6">
              <div class="d-flex align-items-center justify-content-end flex-wrap grid gap-2">
                <div class="rounded bg-dark-subtle p-1 hover-underline">
                  <a href="/tag/{{ $question->id }}" class="text-decoration-none text-black">{{ $question->tag->name }}</a>
                </div>
